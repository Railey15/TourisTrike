...
class _TermsScreenState extends State<TermsScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      final matchingRows = await _supabase
      ...
      debugPrint('TermsScreen _loadData error: $error');
      debugPrintStack(stackTrace: stackTrace);
      if (!mounted) return;
      setState(() => _loading = false);
      _showError('Unable to load the terms and conditions.');
    }
  }
                ...
                child: ListView(
                  ...
                  children: [
                    if (_loading)
                      ...
                      const _EmptyState(
                        message:
                            'No published terms and conditions are available yet.',
                      )
                    else
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            policy.title.trim().isEmpty ? 'Terms & Conditions' : policy.title,
