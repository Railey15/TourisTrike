...
class _TouristMessagesScreenState extends State<TouristMessagesScreen> {
  ...
  Future<List<_ConversationItem>> _loadConversations() async {
    ...
    try {
      ...
      return convList.map((row) {
        ...
        final driver = profileMap[driverId];
        ...
        final avatarUrl =
            (driver?['avatar_url'] as String? ?? '').trim().isNotEmpty
      ...
      debugPrint('MESSAGES _loadConversations error: $error');
  ...
  void _subscribeRealtime() {
    ...
    _channel = _supabase
        .channel('tourist-conversations:${user.id}')
        .onPostgresChanges(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => TouristChatScreen(
          ...
          driverAvatar: conversation.driverAvatar,
        ),
      ),
    ).then((_) {
      if (!mounted) return;
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (conversations.isEmpty) {
                          return RefreshIndicator(
                            ...
                            onRefresh: _refresh,
                            child: const _EmptyConversationList(),
                          );
                        }
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                ...
                colors: [Color(0xFFEFF6FF), Color(0xFFE1EEFF)],
              ),
...
class _ConversationSectionHeader extends StatelessWidget {
  const _ConversationSectionHeader({required this.count});
...
class _ConversationCard extends StatelessWidget {
          ...
          child: Row(
            children: [
              _DriverAvatar(
                ...
                imageUrl: conversation.driverAvatar,
                size: 56,
                showOnlineDot: true,
              ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 12.5,
                              color: conversation.lastMessage.trim().isEmpty
                                  ? const Color(0xFFA7B2C1)
  ...
  static String _formatTime(DateTime rawDate) {
          ...
          Positioned.fill(
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xFFEAF3FF),
                shape: BoxShape.circle,
                border: Border.all(color: const Color(0xFFE1EAF5), width: 2),
              ),
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                ...
                colors: [Color(0xFFF1F7FF), Color(0xFFE4F0FF)],
              ),
...
class _TouristChatScreenState extends State<TouristChatScreen> {
  ...
  late Future<List<_Message>> _messagesFuture;
  ...
  Future<void> _sendMessage() async {
    ...
    if (text.isEmpty || _sending || _myId.isEmpty) {
      return;
    }
        ...
        child: Column(
          children: [
            _ChatHeader(
              ...
              hasPhone: widget.driverPhone.trim().isNotEmpty,
            ...
            Expanded(
              child: FutureBuilder<List<_Message>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (messages.isEmpty) {
                    return _ChatEmptyState(driverName: widget.driverName);
                  }
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Column(
                        children: [
                          if (showDate) _DateLabel(date: message.createdAt),
...
class _ChatHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.fromLTRB(8, 9, 12, 11),
      decoration: BoxDecoration(
        color: Colors.white,
        border: const Border(bottom: BorderSide(color: Color(0xFFE9EEF5))),
        boxShadow: [
          BoxShadow(
...
class _ChatEmptyState extends StatelessWidget {
  const _ChatEmptyState({required this.driverName});
...
class _MessageComposer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.fromLTRB(14, 10, 14, 10 + bottomSafe),
      decoration: BoxDecoration(
        color: Colors.white,
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: sending
                        ? const [Color(0xFF9ACBFF), Color(0xFF73B5FA)]
                        : const [
                            Color(0xFF55ACFF),
                            Color(0xFF2A86FF),
                            Color(0xFF2563EB),
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: const Color(
                        0xFF2A86FF,
                      ).withValues(alpha: sending ? 0.12 : 0.25),
                      blurRadius: 13,
        ...
        decoration: BoxDecoration(
          gradient: isMe
              ? const LinearGradient(
                  ...
                  colors: [Color(0xFF469FFF), Color(0xFF2A86FF)],
                )
              : null,
          ...
          border: isMe ? null : Border.all(color: const Color(0xFFE6ECF3)),
          boxShadow: [
            BoxShadow(
...
class _DateLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (difference == 0) {
      ...
      label = DateFormat('MMMM d, yyyy').format(localDate);
    }
